...
<head>
    ...
    <title>Report Post | <?php echo SITENAME; ?></title>
</head>
    ...
    <div class="dashboard-container">
        ...
        <main>
            <div class="create-announcement-container">
                ...
                <form action="<?php echo URLROOT; ?>/posts/reportPost/<?php echo $data['post_id']; ?>" method="POST" class="announcement-form">
                    <div class="form-group">
                        <label for="reason">Reason for Reporting:</label>
                        <textarea name="reason" id="reason" rows="10"
                            class="form-control <?php echo (!empty($data['reason_err'])) ? 'is-invalid' : ''; ?>"
                            placeholder="Please provide details about why you are reporting this post" required></textarea>
                        <span class="invalid-feedback"><?php echo isset($data['reason_err']) ? $data['reason_err'] : ''; ?></span>
                    </div>

                    <div class="form-actions">
                        <a href="<?php echo URLROOT; ?>/posts/index" class="btn btn-cancel">Cancel</a>

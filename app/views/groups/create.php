                ...
                <div class="create-group-container">
                    ...
                    <form action="<?php echo URLROOT; ?>/groups/create" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="rules" id="rules" rows="4" class="form-control" 
                                    placeholder="Optional: Set guidelines for group members"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="image">Group Image (Optional):</label>

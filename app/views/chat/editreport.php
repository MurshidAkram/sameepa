...
<head>
    ...
    <title>Edit Chat Report | <?php echo SITENAME; ?></title>
</head>
...
<body>
   ...
   class="<?php echo ($current_page == (($_SESSION['user_role_id'] == 3) ? 'report' : 'myreports')) ? 'active' : ''; ?>">
    <?php echo ($_SESSION['user_role_id'] == 3) ? 'Reports' : 'My Reports'; ?>
</a>
                </nav>
            </aside>

            <div class="groups-content">
                <h1>Edit Chat Report</h1>
                <p>Edit the details of your chat report below.</p>

                <form action="<?php echo URLROOT; ?>/chat/updatereport/<?php echo $data['report']->id; ?>" method="POST" class="report-form">
                    <div class="form-group">
                        <label for="reported_user_message">Reported User or Message Identifier:</label>
                        <input type="text" id="reported_user_message" name="reported_user_message" value="<?php echo htmlspecialchars($data['reported_user_message']); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <select id="report_category" name="report_category" required>
                            ...
                            <option value="inappropriate_content" <?php echo ($data['category'] == 'inappropriate_content') ? 'selected' : ''; ?>>Inappropriate Content</option>
                            <option value="harassment" <?php echo ($data['category'] == 'harassment') ? 'selected' : ''; ?>>Harassment</option>
                            <option value="spam" <?php echo ($data['category'] == 'spam') ? 'selected' : ''; ?>>Spam</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="report_description" name="report_description" rows="6" required><?php echo htmlspecialchars($data['description']); ?></textarea>
                    ...
                    <div class="form-buttons">
                        ...
                        <a href="<?php echo URLROOT; ?>/chat/viewreport/<?php echo $data['report']->id; ?>" class="btn-cancel">Cancel</a>
                    </div>
                </form>
            </div>
        </main>

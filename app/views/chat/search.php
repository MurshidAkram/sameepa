        ...
        <main class="groups-main">
            ...
            <div class="groups-content">
                ...
                <form class="groups-search" method="GET" action="<?php echo URLROOT; ?>/chat/search">
                    <input type="text" name="search" placeholder="Search users by name">
                ...
                <div class="groups-grid">
                    <?php if (!empty($data['users'])): ?>
                        <?php foreach ($data['users'] as $user): ?>
                            ...
                            <?php else : ?>
                                <img src="<?php echo URLROOT; ?>/img/default-user.png" alt="No image available" class="group-image">
                            <?php endif; ?>
                                <div class="group-details">
                                    <h3 class="group-title"><?php echo $user->name; ?></h3>
                                    <div class="group-actions">
                                        <a href="<?php echo URLROOT; ?>/chat/sendRequest/<?php echo $user->id; ?>" class="btn-send-request">Send Request</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>

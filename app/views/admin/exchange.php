...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin/exchange.css">
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="exchange-main">
            <h1>Manage Product and Resource Exchange Center</h1>
            <p>Welcome to the Exchange Center Management page. Here, you can add, view, or remove Products and Resources in Exchange Center.</p>
                ...
                ?>
                    <div class="listing-card <?php echo $listing['type']; ?>">
                        ...
                        <div class="listing-actions">
                            <a href="<?php echo URLROOT; ?>/resident/listing/<?php echo $listing['id']; ?>" class="btn-view-listing">View</a>
                            <a href="<?php echo URLROOT; ?>/resident/edit/<?php echo $listing['id']; ?>" class="btn-edit-listing">Edit</a>
                            <a href="<?php echo URLROOT; ?>/resident/delete/<?php echo $listing['id']; ?>" class="btn-delete-listing">Delete</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>

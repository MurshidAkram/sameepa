                    ...
                    ?>
                        <div class="event-card">
                            ...
                            <div class="event-actions">
                                <a href="<?php echo URLROOT; ?>/resident/event/<?php echo $event['id']; ?>" class="btn-view-event">View Event</a>
                                <a href="<?php echo URLROOT; ?>/resident/join_event/<?php echo $event['id']; ?>" class="btn-join-event">Join Event</a>
                                <a href="<?php echo URLROOT; ?>/admin/edit_event/<?php echo $event['id']; ?>" class="btn-edit-event">Edit Event</a>
                                <a href="<?php echo URLROOT; ?>/admin/delete_event/<?php echo $event['id']; ?>" class="btn-delete-event">Delete Event</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>

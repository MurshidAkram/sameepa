...
<head>
    ...
    <title>Update Event | <?php echo SITENAME; ?></title>
</head>
        ...
        <main class="events-main">
            ...
            <div class="events-content">
                <div class="create-event-container">
                    ...
                    <form action="<?php echo URLROOT; ?>/events/update/<?php echo $data['id']; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="image">Update Event Image (Optional):</label>
                        ...
                        <div class="form-buttons">
                            ...
                            <a href="<?php echo URLROOT; ?>/events/viewevent/<?php echo $data['id']; ?>" class="btn-cancel">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>

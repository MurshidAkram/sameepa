...
<aside>
    ...
    <ul>
        ...
        <li><a href="<?php echo URLROOT; ?>/security/Manage_Visitor_Passes">Manage Visitor Passes</a></li>
        ...
        <li><a href="<?php echo URLROOT; ?>/security/Duty_Schedule">Duty Schedule</a></li>

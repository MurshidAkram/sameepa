    ...
    public function registerUser($userData)
{
    ...
    // Corrected SQL query with proper closing parenthesis
    $this->db->query('INSERT INTO users (name, email, password, role_id, is_active, address, phonenumber) 
                      VALUES (:name, :email, :password, :role_id, :is_active, :address, :phonenumber)');
    ...
    $this->db->bind(':address', $userData['address']); // Corrected binding
    $this->db->bind(':phonenumber', $userData['phonenumber']); // Corrected binding
    ...
    public function getUserById($userId)
    {
        ...
        $this->db->query("SELECT name, email, address, phonenumber, role_id FROM users WHERE id = :userId");
